package com.illiapinchuk.testtask.configuration.security.jwt;
...
public class JwtTokenProviderImpl implements JwtTokenProvider {
  ...
  @Override
  public String createToken(@Nonnull final String login, @Nonnull final Set<RoleName> roles) {
    final var claims = Jwts.claims().setSubject(login);
  ...
  public Authentication getAuthentication(@Nonnull final String token) {
    final var userDetails = this.userDetailsService.loadUserByUsername(getLogin(token));
    return new UsernamePasswordAuthenticationToken(userDetails, "", userDetails.getAuthorities());
  }

  @Override
  public String getLogin(@Nonnull final String token) {
    return Jwts.parser()
